...
// node_modules/@algolia/abtesting/dist/builds/browser.js
var browser_exports = {};
...
__export(browser_exports2, {
  ...
  apiClientVersion: () => apiClientVersion2
});
var apiClientVersion2 = "5.43.0";
var REGIONS2 = ["de", "us"];
function getDefaultHosts2(region) {
  const url = !region ? "analytics.algolia.com" : "analytics.{region}.algolia.com".replace("{region}", region);
  return [{ url, accept: "readWrite", protocol: "https" }];
}
function createAbtestingClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts2(regionOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Abtesting",
      version: apiClientVersion2
    }),
    baseHeaders: {
      "content-type": "text/plain",
      ...auth.headers(),
...
function abtestingClient(appId, apiKey, region, options) {
  ...
  if (region && (typeof region !== "string" || !REGIONS2.includes(region))) {
    throw new Error(`\`region\` must be one of the following: ${REGIONS2.join(", ")}`);
  }
  return createAbtestingClient({
    ...
    requestsCache: createMemoryCache({ serializable: false }),
    hostsCache: createFallbackableCache({
      caches: [createBrowserLocalStorageCache({ key: `${apiClientVersion2}-${appId}` }), createMemoryCache()]
    }),
    ...options
  });
}
...
__export(browser_exports3, {
  ...
  apiClientVersion: () => apiClientVersion3
});
var apiClientVersion3 = "5.43.0";
var REGIONS3 = ["de", "us"];
function getDefaultHosts3(region) {
  const url = !region ? "analytics.algolia.com" : "analytics.{region}.algolia.com".replace("{region}", region);
  return [{ url, accept: "readWrite", protocol: "https" }];
}
function createAnalyticsClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts3(regionOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Analytics",
      version: apiClientVersion3
    }),
    baseHeaders: {
      "content-type": "text/plain",
      ...auth.headers(),
...
function analyticsClient(appId, apiKey, region, options) {
  ...
  if (region && (typeof region !== "string" || !REGIONS3.includes(region))) {
    throw new Error(`\`region\` must be one of the following: ${REGIONS3.join(", ")}`);
  }
  return createAnalyticsClient({
    ...
    requestsCache: createMemoryCache({ serializable: false }),
    hostsCache: createFallbackableCache({
      caches: [createBrowserLocalStorageCache({ key: `${apiClientVersion3}-${appId}` }), createMemoryCache()]
    }),
    ...options
  });
}
...
var browser_exports4 = {};
__export(browser_exports4, {
  apiClientVersion: () => apiClientVersion4,
  insightsClient: () => insightsClient
});
var apiClientVersion4 = "5.43.0";
var REGIONS4 = ["de", "us"];
function getDefaultHosts4(region) {
...
function createInsightsClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts4(regionOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Insights",
      version: apiClientVersion4
    }),
    baseHeaders: {
      "content-type": "text/plain",
      ...auth.headers(),
...
function insightsClient(appId, apiKey, region, options) {
  ...
  if (region && (typeof region !== "string" || !REGIONS4.includes(region))) {
    throw new Error(`\`region\` must be one of the following: ${REGIONS4.join(", ")}`);
  }
  return createInsightsClient({
    ...
    requestsCache: createMemoryCache({ serializable: false }),
    hostsCache: createFallbackableCache({
      caches: [createBrowserLocalStorageCache({ key: `${apiClientVersion4}-${appId}` }), createMemoryCache()]
    }),
    ...options
  });
}
...
var browser_exports5 = {};
__export(browser_exports5, {
  apiClientVersion: () => apiClientVersion5,
  personalizationClient: () => personalizationClient
});
var apiClientVersion5 = "5.43.0";
var REGIONS5 = ["eu", "us"];
function getDefaultHosts5(region) {
...
function createPersonalizationClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts5(regionOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Personalization",
      version: apiClientVersion5
    }),
    baseHeaders: {
      "content-type": "text/plain",
      ...auth.headers(),
...
function personalizationClient(appId, apiKey, region, options) {
  ...
  if (!region || region && (typeof region !== "string" || !REGIONS5.includes(region))) {
    throw new Error(`\`region\` is required and must be one of the following: ${REGIONS5.join(", ")}`);
  }
  return createPersonalizationClient({
    ...
    requestsCache: createMemoryCache({ serializable: false }),
    hostsCache: createFallbackableCache({
      caches: [createBrowserLocalStorageCache({ key: `${apiClientVersion5}-${appId}` }), createMemoryCache()]
    }),
    ...options
  });
}
...
var browser_exports6 = {};
__export(browser_exports6, {
  apiClientVersion: () => apiClientVersion6,
  querySuggestionsClient: () => querySuggestionsClient
});
var apiClientVersion6 = "5.43.0";
var REGIONS6 = ["eu", "us"];
function getDefaultHosts6(region) {
...
function createQuerySuggestionsClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts6(regionOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "QuerySuggestions",
      version: apiClientVersion6
    }),
    baseHeaders: {
      "content-type": "text/plain",
      ...auth.headers(),
...
function querySuggestionsClient(appId, apiKey, region, options) {
  ...
  if (!region || region && (typeof region !== "string" || !REGIONS6.includes(region))) {
    throw new Error(`\`region\` is required and must be one of the following: ${REGIONS6.join(", ")}`);
  }
  return createQuerySuggestionsClient({
    ...
    requestsCache: createMemoryCache({ serializable: false }),
    hostsCache: createFallbackableCache({
      caches: [createBrowserLocalStorageCache({ key: `${apiClientVersion6}-${appId}` }), createMemoryCache()]
    }),
    ...options
  });
}
...
var browser_exports7 = {};
__export(browser_exports7, {
  apiClientVersion: () => apiClientVersion7,
  searchClient: () => searchClient
});
var apiClientVersion7 = "5.43.0";
function getDefaultHosts7(appId) {
  return [
    {
...
function createSearchClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts7(appIdOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Search",
      version: apiClientVersion7
    }),
    baseHeaders: {
      "content-type": "text/plain",
      ...auth.headers(),
...
function searchClient(appId, apiKey, options) {
  ...
  return createSearchClient({
    ...
    requestsCache: createMemoryCache({ serializable: false }),
    hostsCache: createFallbackableCache({
      caches: [createBrowserLocalStorageCache({ key: `${apiClientVersion7}-${appId}` }), createMemoryCache()]
    }),
    ...options
  });
}
...
var browser_exports8 = {};
__export(browser_exports8, {
  apiClientVersion: () => apiClientVersion8,
  ingestionClient: () => ingestionClient,
  isOnDemandTrigger: () => isOnDemandTrigger,
  isScheduleTrigger: () => isScheduleTrigger,
  isSubscriptionTrigger: () => isSubscriptionTrigger
});
var apiClientVersion8 = "1.43.0";
var REGIONS7 = ["eu", "us"];
function getDefaultHosts8(region) {
...
function createIngestionClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts8(regionOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Ingestion",
      version: apiClientVersion8
    }),
    baseHeaders: {
      "content-type": "text/plain",
      ...auth.headers(),
...
function ingestionClient(appId, apiKey, region, options) {
  ...
  if (!region || region && (typeof region !== "string" || !REGIONS7.includes(region))) {
    throw new Error(`\`region\` is required and must be one of the following: ${REGIONS7.join(", ")}`);
  }
  return createIngestionClient({
    ...
    requestsCache: createMemoryCache({ serializable: false }),
    hostsCache: createFallbackableCache({
      caches: [createBrowserLocalStorageCache({ key: `${apiClientVersion8}-${appId}` }), createMemoryCache()]
    }),
    ...options
  });
}
...
var browser_exports9 = {};
__export(browser_exports9, {
  apiClientVersion: () => apiClientVersion9,
  monitoringClient: () => monitoringClient
});
var apiClientVersion9 = "1.43.0";
function getDefaultHosts9() {
...
function createMonitoringClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts9(),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Monitoring",
      version: apiClientVersion9
    }),
    baseHeaders: {
      "content-type": "text/plain",
      ...auth.headers(),
...
function monitoringClient(appId, apiKey, options) {
  ...
  return createMonitoringClient({
    ...
    requestsCache: createMemoryCache({ serializable: false }),
    hostsCache: createFallbackableCache({
      caches: [createBrowserLocalStorageCache({ key: `${apiClientVersion9}-${appId}` }), createMemoryCache()]
    }),
    ...options
  });
}
...
var browser_exports10 = {};
__export(browser_exports10, {
  apiClientVersion: () => apiClientVersion10,
  recommendClient: () => recommendClient
});
var apiClientVersion10 = "5.43.0";
function getDefaultHosts10(appId) {
  return [
    {
      url: `${appId}-dsn.algolia.net`,
      accept: "read",
...
function createRecommendClient({
  ...
  const auth = createAuth(appIdOption, apiKeyOption, authMode);
  const transporter = createTransporter({
    hosts: getDefaultHosts10(appIdOption),
    ...options,
    algoliaAgent: getAlgoliaAgent({
      algoliaAgents,
      client: "Recommend",
      version: apiClientVersion10
    }),
    baseHeaders: {
      "content-type": "text/plain",
      ...auth.headers(),
...
function recommendClient(appId, apiKey, options) {
  ...
  return createRecommendClient({
    ...
    requestsCache: createMemoryCache({ serializable: false }),
    hostsCache: createFallbackableCache({
      caches: [createBrowserLocalStorageCache({ key: `${apiClientVersion10}-${appId}` }), createMemoryCache()]
    }),
    ...options
  });
}
...
var browser_exports11 = {};
__export2(browser_exports11, {
...
__reExport(models_exports, browser_exports);
__reExport(models_exports, browser_exports2);
__reExport(models_exports, browser_exports3);
__reExport(models_exports, browser_exports4);
__reExport(models_exports, browser_exports5);
__reExport(models_exports, browser_exports6);
__reExport(models_exports, browser_exports7);
__reExport(models_exports, browser_exports8);
__reExport(models_exports, browser_exports9);
__reExport(models_exports, browser_exports10);
__reExport(browser_exports11, models_exports);
...
export {
  algoliasearch,
  apiClientVersion7 as apiClientVersion
};
